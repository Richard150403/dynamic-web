...
# That added string will be captured using a variable called name as shown below.
# Note that the variable does not have to be called name. It is simply convenient to use it here.
@app.route("/hello/<string:name>/")
def hello_with_person_name(name):
    # The two lines below will work. But the second line is more convenient as it
